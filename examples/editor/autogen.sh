...
# ...actually, don't. Just use autoreconf from the top dir instead.
...
echo "Warning: you should just use autoreconf from the top srcdir instead of this script."
...
if test "x${I_AM_THE_MAINTAINER}" = "xyes"; then
