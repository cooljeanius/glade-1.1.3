...
EXTRA_DIST =  	FAQ 	glade.spec 	glade.spec.in 	glade-2.desktop.in 	glade-2.png 	intltool-extract.in 	intltool-merge.in 	intltool-update.in 	examples/editor/AUTHORS 	examples/editor/ChangeLog 	examples/editor/Makefile.am 	examples/editor/NEWS 	examples/editor/README 	examples/editor/acconfig.h 	examples/editor/autogen.sh 	examples/editor/configure.in 	examples/editor/editor.glade 	examples/editor/src/Makefile.am 	examples/editor/src/callbacks.c 	examples/editor/src/callbacks.h 	examples/editor/src/interface.c 	examples/editor/src/interface.h 	examples/editor/src/main.c 	examples/editor/src/support.c 	examples/editor/src/support.h 	examples/editor/pixmaps/new.xpm 	examples/editor/pixmaps/open.xpm 	examples/editor/pixmaps/save.xpm 	examples/editor/po/ChangeLog 	examples/editor/po/POTFILES.in
...
glade.spec.in install-sh ltmain.sh missing mkinstalldirs
...
glade.spec: $(top_builddir)/config.status glade.spec.in
	cd $(top_builddir) && CONFIG_FILES=$@ CONFIG_HEADERS= $(SHELL) ./config.status

install-DevelopmentDATA: $(Development_DATA)
	@$(NORMAL_INSTALL)
	$(mkinstalldirs) $(DESTDIR)$(Developmentdir)
	@list='$(Development_DATA)'; for p in $$list; do \
	  if test -f $(srcdir)/$$p; then \
	    echo " $(INSTALL_DATA) $(srcdir)/$$p $(DESTDIR)$(Developmentdir)/$$p"; \
	    $(INSTALL_DATA) $(srcdir)/$$p $(DESTDIR)$(Developmentdir)/$$p; \
	  else if test -f $$p; then \
	    echo " $(INSTALL_DATA) $$p $(DESTDIR)$(Developmentdir)/$$p"; \
	    $(INSTALL_DATA) $$p $(DESTDIR)$(Developmentdir)/$$p; \
	  fi; fi; \
	done
...
distdir: $(DISTFILES)
	...
	mkdir $(distdir)
	-chmod 777 $(distdir)
	$(mkinstalldirs) $(distdir)/examples/editor \
	   $(distdir)/examples/editor/pixmaps \
	   $(distdir)/examples/editor/po $(distdir)/examples/editor/src
...
install-data-am: install-DevelopmentDATA install-pixmapsDATA \
		install-data-local
...
installdirs-am:
	$(mkinstalldirs)  $(DESTDIR)$(Developmentdir) $(DESTDIR)$(pixmapsdir)
...
uninstall-DevelopmentDATA install-DevelopmentDATA uninstall-pixmapsDATA \
install-pixmapsDATA install-data-recursive uninstall-data-recursive \
